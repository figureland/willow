...
const INPUT_SPEC: Record<IssueCode, FixInputSpec> = {
  ...
  'duplicate-cropping': {
    kind: 'choice',
    label: 'Which record to keep',
    options: [
      { value: 'keep-first', label: 'Keep the first record' },
      { value: 'keep-second', label: 'Keep the second record' },
      { value: 'keep-both', label: 'Keep both (mark as intentional)' },
    ],
    suggestion: 'keep-first',
  },
  'duplicate-operation': {
    kind: 'choice',
    label: 'How to handle the duplicates',
    options: [
      { value: 'keep-first', label: 'Keep the first application' },
      { value: 'keep-second', label: 'Keep the second application' },
      { value: 'keep-both', label: 'Confirm both happened' },
    ],
  ...
  'duplicate-fertiliser': {
    ...
    label: 'How to handle the duplicates',
    options: [
      { value: 'keep-first', label: 'Keep the first row' },
      { value: 'keep-second', label: 'Keep the second row' },
      { value: 'keep-both', label: 'Confirm both happened' },
    ],
    suggestion: 'keep-first',
  },
  'duplicate-farm': {
    kind: 'choice',
    label: 'Merge or keep separate',
    options: [
      { value: 'merge', label: 'Merge with existing farm' },
      { value: 'keep-separate', label: 'Keep as a new farm' },
    ],
    suggestion: 'merge',
  },
  'orphan-operation': {
    kind: 'choice',
    label: 'Attach to cropping record',
    options: [
